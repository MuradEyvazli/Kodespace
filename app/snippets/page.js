            ...
            {viewMode === 'grid' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-12">
                {snippets.map((snippet) => {
                  ...
                  return (
                    <Link key={snippet._id} href={`/snippets/${snippet._id}`} className="group">
                      <div className="relative bg-white rounded-2xl border-2 border-gray-200 overflow-hidden transition-all duration-300 hover:border-purple-400 hover:shadow-2xl hover:-translate-y-1">
                        {/* Gradient Background Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 via-pink-50/30 to-blue-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                        {/* Verified Badge */}
                        {snippet.isVerified && (
                          <div className="absolute top-3 right-3 z-10">
                            <div className="flex items-center space-x-1 px-2.5 py-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full shadow-lg">
                        ...
                        <div className="relative p-5 md:p-6">
                          ...
                          <div className="absolute top-3 left-3">
                            <div className="px-3 py-1.5 bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl shadow-md">
                              <span className="text-white text-xs font-bold tracking-wide">{snippet.language}</span>
                            </div>
                          </div>

                          {/* Title & Description */}
                          <div className="mt-10 mb-4">
                            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 transition-all duration-300">
                              {snippet.title}
                            </h3>
                          ...
                          {/* Difficulty Badge */}
                          <div className="mb-4">
                            <div className={`inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl ${difficultyInfo.bgColor} border-2 border-transparent group-hover:border-current transition-all duration-300`}>
                              <span className="text-lg">{difficultyInfo.icon}</span>
                              <span className={`${difficultyInfo.textColor} text-xs font-bold uppercase tracking-wide`}>
                                {snippet.difficulty}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-1.5 mb-5">
                            {snippet.tags.slice(0, 3).map((tag) => (
                              <span key={tag} className="px-2.5 py-1 rounded-lg bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 text-xs font-medium border border-blue-200 group-hover:border-blue-400 transition-colors">
                                #{tag}
                              </span>
                            ))}
                            {snippet.tags.length > 3 && (
                              <span className="px-2.5 py-1 rounded-lg bg-gray-100 text-gray-600 text-xs font-medium border border-gray-300">
                                +{snippet.tags.length - 3}
                              </span>
                            )}
                          </div>
                          ...
                          {/* Stats Bar */}
                          <div className="flex items-center justify-between py-3 px-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 group-hover:border-purple-300 group-hover:from-purple-50 group-hover:to-pink-50 transition-all duration-300">
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-purple-600 transition-colors">
                                ...
                                <span className="text-sm font-semibold">{snippet.usage?.views || 0}</span>
                              </div>
                              <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-pink-600 transition-colors">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                  <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                                </svg>
                                <span className="text-sm font-semibold">{snippet.usage?.likes || 0}</span>
                              </div>
                              <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-blue-600 transition-colors">
                                ...
                                <span className="text-sm font-semibold">{snippet.usage?.bookmarks || 0}</span>
                              </div>
                            </div>
                            <div className="flex items-center space-x-1.5 text-purple-600 font-semibold group-hover:translate-x-1 transition-transform">
                          ...
                          {/* Author */}
                          <div className="mt-4 pt-4 border-t border-gray-200 group-hover:border-purple-300 transition-colors">
                            <div className="flex items-center space-x-3">
                              <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${roleInfo.color} flex items-center justify-center text-white shadow-md group-hover:shadow-lg group-hover:scale-110 transition-all duration-300`}>
                                <span className="text-base font-bold">{roleInfo.icon}</span>
                              </div>
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-bold text-gray-900 group-hover:text-purple-600 transition-colors truncate">
                                  {snippet.author.name}
                                </div>
                        ...
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                          <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-2xl blur opacity-30"></div>
                        </div>
                      </div>
                    </Link>
                  );
              ...
              <div className="space-y-4 md:space-y-6 mb-12">
                {snippets.map((snippet) => {
                  ...
                  return (
                    <Link key={snippet._id} href={`/snippets/${snippet._id}`} className="group block">
                      <div className="relative bg-white rounded-2xl border-2 border-gray-200 overflow-hidden transition-all duration-300 hover:border-purple-400 hover:shadow-2xl">
                        {/* Gradient Background Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-50/50 via-pink-50/30 to-blue-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                        <div className="relative p-4 sm:p-6">
                          <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6">
                            {/* Left: Language Badge & Icon */}
                            <div className="flex items-center lg:flex-col lg:items-center gap-3 lg:gap-4 flex-shrink-0">
                              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                                <svg className="w-8 h-8 lg:w-10 lg:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                                </svg>
                              </div>
                              <div className="lg:text-center">
                                <div className="px-3 py-1.5 bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl shadow-md inline-block">
                                  <span className="text-white text-xs font-bold tracking-wide">{snippet.language}</span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-start justify-between gap-3 mb-3">
                                <h3 className="text-lg sm:text-xl font-bold text-gray-900 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 transition-all duration-300 line-clamp-1">
                                  {snippet.title}
                                </h3>
                                {snippet.isVerified && (
                                  <div className="flex-shrink-0">
                                    <div className="flex items-center space-x-1 px-2.5 py-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full shadow-lg">
                                      ...
                                      <span className="text-white text-xs font-bold hidden sm:inline">Verified</span>
                                    </div>
                                  </div>
                                )}
                              </div>
                              ...
                              <div className="flex flex-wrap items-center gap-2 mb-4">
                                <div className={`inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl ${difficultyInfo.bgColor} border-2 border-transparent group-hover:border-current transition-all duration-300`}>
                                  <span className="text-base">{difficultyInfo.icon}</span>
                                  <span className={`${difficultyInfo.textColor} text-xs font-bold uppercase tracking-wide`}>
                                    {snippet.difficulty}
                                  </span>
                                </div>
                              ...
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <div className="flex items-center space-x-2 text-xs text-gray-500">
                                      <span className="font-medium truncate">{roleInfo.name}</span>
                                      <span className="hidden sm:inline">•</span>
                                      <span className="hidden sm:inline truncate">{formatDate(snippet.createdAt)}</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between sm:justify-end gap-4">
                                  <div className="flex items-center space-x-3 text-sm">
                                    <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-purple-600 transition-colors">
                                      ...
                                      <span className="font-semibold">{snippet.usage?.views || 0}</span>
                                    </div>
                                    <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-pink-600 transition-colors">
                                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                                      </svg>
                                      <span className="font-semibold">{snippet.usage?.likes || 0}</span>
                                    </div>
                                    <div className="flex items-center space-x-1.5 text-gray-600 group-hover:text-blue-600 transition-colors">
                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                                      </svg>
                                      <span className="font-semibold">{snippet.usage?.bookmarks || 0}</span>
                                    </div>
                                  </div>

                                  <div className="flex items-center space-x-1.5 text-purple-600 font-bold group-hover:translate-x-1 transition-transform">
                                    <span className="text-sm">View</span>
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
